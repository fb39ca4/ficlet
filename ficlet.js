...
if (mobile) {
    ...
    else if (isNaN(parseInt(document.getElementById("top").getElementsByTagName("center")[2].getElementsByTagName("a")[0].innerHTML))) {
        var numChapters = 1;
    }
    else var numChapters = 2;
    var titleStr = document.getElementById("content").getElementsByTagName("b")[0].innerHTML;
    var authorStr = document.getElementById("content").getElementsByTagName("a")[0].text;
}
else {
...
downloadFrame.onload = function() {
    if (mobile) {
        ...
        if (numChapters == 1) {
            chapterTitle[chapterIdx] = titleStr;
        }
        else {
